...
public abstract class BaseItemdbDAO extends cn.eas.dao._RootDAO {
	...
	public cn.eas.Itemdb get(java.lang.String key)
	{
		return (cn.eas.Itemdb) get(getReferenceClass(), key);
	}

	public cn.eas.Itemdb get(java.lang.String key, Session s)
	{
		return (cn.eas.Itemdb) get(getReferenceClass(), key, s);
	}

	public cn.eas.Itemdb load(java.lang.String key)
	{
		return (cn.eas.Itemdb) load(getReferenceClass(), key);
	}

	public cn.eas.Itemdb load(java.lang.String key, Session s)
	{
		return (cn.eas.Itemdb) load(getReferenceClass(), key, s);
	}

	public cn.eas.Itemdb loadInitialize(java.lang.String key, Session s) 
	{ 
...
/* Generic methods */
	 ...
	 */
	public java.lang.String save(cn.eas.Itemdb itemdb)
	{
		return (java.lang.String) super.save(itemdb);
	}
	 ...
	 * @return the class identifier
	 */
	public java.lang.String save(cn.eas.Itemdb itemdb, Session s)
	{
		return (java.lang.String) save((Object) itemdb, s);
	}
